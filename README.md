...
To run BCI_paint or BCI_gaming apps, the project needs to be built into executable first. run the following in each project's path to create the executable: 
