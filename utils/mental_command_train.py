...
class Train():
    ...
    def __init__(self, app_client_id, app_client_secret, **kwargs):
        self.c = CortexV2(app_client_id, app_client_secret, debug_mode=True, **kwargs)
    ...
    def on_inform_error(self, *args, **kwargs):
        ...
        if error_code == cortexV2.ERR_PROFILE_ACCESS_DENIED:
...
def train_mental_cmd(user, profile_name, action):
    t = Train(user['client_id'], user['client_secret'])
    actions = [action]
...
train_mental_cmd(user, 'testprof','neutral')